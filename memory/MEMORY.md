...
- [Project Channels & Dynamic Routing](project_channels_routing.md) — Allowed channel types, dynamic outbox routing per marketplace and gateway, multi-BU workflow requirements, BU data isolation rules (CMG/CFR isolation, JWT-enforced filtering, 403 on cross-BU mutations), POD routing differences (invoice at Delivered, STS invoice/credit note to TMS+GW not WMS)
